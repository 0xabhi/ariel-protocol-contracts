...
async function main() {
  ...
  */
  ...
  let deployedContracts = {
    ...
    usdc: usdc.address,
    poolCAP: poolCAP.address,
    poolETH: poolETH.address,
    poolUSDC: poolUSDC.address,
    poolRewardsETH: poolRewardsETH.address,
    poolRewardsUSDC: poolRewardsUSDC.address,
    capRewardsETH: capRewardsETH.address,
    capRewardsUSDC: capRewardsUSDC.address,
    darkOracleAddress
  };
  await fs.writeFile("contracts.json", JSON.stringify(deployedContracts), function (err) {
    if (err) throw err;
